...
export const menuData = {
    ...
    "Pizzas Estofadas": [
        { nombre: "Estofada de Carnes",  opciones: preciosPizzas.estofada, esEstofada: true, descripcion: "Jamón, salchicha, salami, pollo, champiñón, queso y salsa napolitana." },
    ...
    "Pizzas Especiales": [
        ...
        { nombre: "Teriyaki",           opciones: preciosPizzas.especial,          descripcion: "Carne a la bolognesa o pollo, vegetales al wok en salsa teriyaki." },
        ...
        { nombre: "La Majestuosa",      opciones: preciosPizzas.majestuosaPequeña, descripcion: "Stroganoff lomo de res, champiñones, tomates cherry, queso brie, balsámico al brandy, cebolla crocante y albahaca." },
