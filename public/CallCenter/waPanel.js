...
/* Especificidad 0-2-0 supera a .wap-input-row button (0-1-1) → sin fondo verde */
.wap-input-row .wap-emoji-cat-btn {
    flex-shrink: 0;
    background: none;
    border: none;
...
.wap-input-row .wap-emoji-cat-btn:hover { background: rgba(0,0,0,.05); }
.wap-input-row .wap-emoji-cat-btn.active { border-bottom-color: #6b7280; }
.wap-emoji-grid {
    display: grid;
