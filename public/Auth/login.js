...
login_form.addEventListener("submit", async (e) => {
    ...
    try {
        ...
        if (userDoc.exists()) {
            ...
            if (userData.rol === 'admin') window.location.href = 'selector.html';
            else if (userData.rol === 'planta') window.location.href = 'Planta/dashboard.html';
            else if (userData.rol === 'planta-admin') window.location.href = 'Planta/dashboard.html';
            else if (userData.rol === 'callcenter') window.location.href = 'CallCenter/callcenter-shell.html';
            else if (userData.rol === 'callcenter-admin') window.location.href = 'CallCenter/callcenter-shell.html';
            else if (userData.rol === 'pizzeria') window.location.href = 'Pizzerias/pizzerias.html';
