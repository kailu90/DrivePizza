...
const EXCEPCIONES = new Set(['x', 'de', 'del', 'la', 'las', 'el', 'los', 'y', 'en', 'con', 'sin', 'por', 'e', 'a']);
...
async function main() {
    ...
    console.log(`🚀 Procesando ${snap.size} proveedores...\n`);
    ...
    await batch.commit();
    console.log(`\n✔ ${cambios} proveedores actualizados en un solo batch.`);
    process.exit(0);
}
